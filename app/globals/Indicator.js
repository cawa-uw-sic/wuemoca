  ...
  */
  {
    ...
    croplist       : ["cotton", "wheat", "rice", "alfa", "orchard", "garden"],
    enCropNames    : ['Cotton', 'Wheat', 'Rice', 'Alfalfa', 'Orchards/Vineyards', 'Urban gardens'],
    ruCropNames    : ['хлопок', 'пшеница', 'рис', 'люцерна', 'фрукты/виноградники', 'Городской сад'],
