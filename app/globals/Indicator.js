  ...
  */
  {
    ...
    enTooltip      : 'Area equipped with irrigation infrastructure (actual and potential irrigated cropland)',
  ...
  */
  {
    ...
    enTooltip      : 'Crop specific area share in Net irrigated area',
  ...
  */
  {
    ...
    ruName         : 'Севооборот',
    enTooltip      : 'Average number of land use alternations including double season crops and fallow land',
  ...
  */
{
    ...
    enTooltip      : 'Economic revenue per m³ water consumed measured in crop specific actual evapotranspiration<br>(Crop_gross_output * Crop_price) / ET<sub>act</sub>_crop',
