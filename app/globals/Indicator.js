  ...
  */
  {
    ...
    enTooltip      : 'Crop-specific area share in total net irrigated area (cropping intensity)',
  ...
  */
  {
    ...
    enTooltip      : 'Variety of different crop types (spatially) within area',
  ...
  */
  {
    ...
    years          : 'all',
    mapType        : 'colored',
    enLegend       : ['Water for Cotton', 'Water for Wheat', 'Water for Rice'],
    ruLegend       : ['Хлопок', 'Пшеница', 'рис'],
    median         : 0,
    maximum        : 0,
    chart          : 'Line',
